...
[CustomEditor(typeof(CSCheckCondition))]
public class CSCheckCondition_Editor : Editor
{
    ...
    CSCheckCondition trg;    //редактируемый объект CSCheckCondition
    string oldPropName;
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("TrueEvent"), new GUIContent("True"));
        EditorGUILayout.PropertyField(serializedObject.FindProperty("FalseEvent"), new GUIContent("False"));
        serializedObject.ApplyModifiedProperties();
    }

    void OnEnable()
    {
        trg = (CSCheckCondition)target;
        oldPropName = trg.PropertyName;
        //if(trg.Comp != null)
        //    gobj = trg.GameObject;
    }
